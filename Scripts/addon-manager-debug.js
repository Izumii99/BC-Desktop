...
(function () {
    ...
    let REPO_API_URL =
        "https://api.github.com/repos/Izumii99/BC-Desktop/contents/Scripts";
    let SCRIPT_BASE_URL =
        "https://raw.githubusercontent.com/Izumii99/BC-Desktop/main/Scripts/";
    ...
    fetch(REPO_API_URL + "?v=" + Date.now())
        .then((response) => response.json())
        .then((data) => {
            if (!Array.isArray(data)) {
                console.error("BC Desktop: Could not read Scripts directory from GitHub API.", data);
                return;
            }
