(function () {
    ...
    qolBody.appendChild(
        createToggle(
            "enableWardrobePagination",
            "Wardrobe Pagination",
            "Adds multi-page support to Wardrobe / Appearance."
        )
    );
...
(function() {
    ...
    function initPaginator() {
        ...
        function getVisualCoords(Left, Top, Width, Height) {
            if (window._bcQolConfig && window._bcQolConfig.enableWardrobePagination === false) return { Left, Top, Valid: true, index: -1 };
        ...
        window.DrawButton = function(Left, Top, Width, Height, Label, Color, Image, HoveringText, Disabled) {
            if (window._bcQolConfig && window._bcQolConfig.enableWardrobePagination === false) return origDrawButton(Left, Top, Width, Height, Label, Color, Image, HoveringText, Disabled);
        ...
        window.addEventListener("mousedown", (e) => {
            if (window._bcQolConfig && window._bcQolConfig.enableWardrobePagination === false) return;
